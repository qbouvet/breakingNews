...
/*
    This class manages the timeflow over the week covered by the dataset, 
    returning incremental timestamps
*/
export class TimeManager {
    ...
    // Clips date below initial timestamp
    ...
    // Clips date above last timestamp
