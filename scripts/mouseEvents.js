...
/*
    Helepers functions for the visualization of the events on the map.
    Show tooltip for each event, handles mouse events.
    Onclick opens a link on a browser tab.
*/
