MAKE_PUBLIC_STATEMENT = {
    ...
    16:'Reject accusation, deny responsibility',
...
APPEAL = {
    ...
    25:'Appeal to yield',
    251:'Appeal for easing of administrative sanction',
    252:'Appeal for easing of political dissent',
    ...
    256:'Appeal for target to de.escalation of military engagement',
...
EXPRESS_INTENT_TO_COOPERATE = {
    ...
    344:'Epress intent to change institutions, regime',
    ...
    356:'Epress intent to de-escalate military engagement',
...
YIELD = {
    ...
    83:'Accede to requests or demands for political reform',
    ...
    84:'Return, release',
    841:'Return, release persons',
    842:'Return, release property',
    85:'Ease economic sanction, boycott ot embargo',
    86:'Allow international involvement',
    861:'Receive deployement of peacekeepers',
    862:'Receive inspectors',
    863:'Allor for humanitarian access',
    87:'De-escalate military engagement',
    871:'Declare truce, creasefire',
    872:'Ease military blockade',
    873:'Demobilize armed forces',
    874:'Retreat or surrender militarly'
}
...
THREATEN = {
    ...
    1322:'Threaten to ban politcal parties or politicians',
...
PROTEST = {
    ...
    1444:'Obstruct passage to demande change in institutions, regime',
    145:'Protest violently, riot',
    1451:'Engage in violent protest for leadership change',
    1452:'Engage in violent protest to demand policy change',
    1453:'Engage in violent protest to demand rights',
    1454:'Engage in violent protest to demand change in institutions, regime'
}
...
REDUCE_RELATIONS = {
    ...
    161:'Reduce or brak diplomatic relations',
...
FIGHT = {
    ...
    195:'Employ aerial weaponds',
    1951:'Employ precision-guided aerial munitions',
    1952:'Employ remotely piloted aerial munitions',
    196:'Violate ceasefire'
}

ENGAGE_IN_UNCONVENTIONAL_MASS_VIOLENCE = {
    200:'Use massive unconventional force',
    201:'Engage in mass expulsion',
    202:'Engage in mass killings',
    203:'Engage in ethnic cleansing',
    204:'Use weapon of mass distruction',
